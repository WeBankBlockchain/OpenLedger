...
contract IdInterface {
    ...
    function addDetailToRes(address resourceGroup, address resource, string operation, bytes detail, bytes32[4] sign) public returns (bool);
    ...
    function removeDetailTFromRes(address resourceGroup, address resource, string operation, bytes detail, bytes32[4] sign) public returns (bool);
