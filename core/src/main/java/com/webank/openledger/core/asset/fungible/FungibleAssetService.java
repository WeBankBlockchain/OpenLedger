...
public class FungibleAssetService extends StandardAssetService<FungibleAsset> {
   ...
   // private IdentityService<FungibleAsset> identity;
     ...
     * @param contractAddress org contractAddress
     */
    public FungibleAssetService(Blockchain blockchain, String contractAddress,String holderAddress) {
        super(blockchain, contractAddress, holderAddress,Organization.class);
