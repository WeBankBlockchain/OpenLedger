...
import com.webank.openledger.contracts.AccountManager;
...
//            projectManager.setAuthManagerAddr(authManager.getContractAddress());
            ...
            AclManager aclManager = AclManager.deploy(blockchain.getDefaultClient(), blockchain.getProjectAccount().getKeyPair());
            projectManager.setAclManagerAddr(aclManager.getContractAddress());
